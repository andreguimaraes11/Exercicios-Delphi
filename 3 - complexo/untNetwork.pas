...
begin
  if (AFirstElement > FTotalElements) or (ASecondElement > FTotalElements) then
    raise Exception.Create('[TNetwork] - Elemento inválido! Elementos passados '+
